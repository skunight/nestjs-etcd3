...
let EtcdCoreModule = EtcdCoreModule_1 = class EtcdCoreModule {
    static root(options) {
        return {
            module: EtcdCoreModule_1,
            providers: [
...
EtcdCoreModule = EtcdCoreModule_1 = __decorate([
    common_1.Global(),
    common_1.Module({
...
exports.EtcdCoreModule = EtcdCoreModule;
